...
def root(context, missing=missing):
    ...
    for (l_1_section, l_1_node_context_), l_1_loop in LoopContext(context.call(environment.getattr((undefined(name='view_object') if l_0_view_object is missing else l_0_view_object), 'table_of_contents')), undefined):
        ...
        yield '">'
        if context.call(environment.getattr(l_1_section, 'is_document'), _loop_vars=_loop_vars):
            pass
        ...
        if (not environment.getattr(l_1_loop, 'last')):
            ...
            l_2_x = missing
            yield '</ul>'
    l_1_loop = l_1_section = l_1_node_context_ = l_1_range = missing

blocks = {}
debug_info = '7=32&8=35&11=39&12=44&13=46&14=48&17=51&18=53&30=58&31=60&35=62&36=64&44=69&45=71&49=73&51=75&52=77&59=80&60=82&62=85&64=88&73=99'